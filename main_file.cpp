...
void drawScene(GLFWwindow* window,float angle_x,float angle_y) {
	...
	M = glm::translate(M, glm::vec3(0.0f, -100.0f, 0.0f));
	...
	//glVertexAttribPointer(sp->a("color"), 4, GL_FLOAT, false, 0, texCoords.data()); //Wskaż tablicę z danymi dla atrybutu color
